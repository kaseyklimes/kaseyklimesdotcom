...
Caption: A mind produces a resource, a resource is produced by a mind
...
Caption: An author may write many books. A book may have many authors.
...
Caption: Every table is linked to all the other tables.
...
Caption: We could think about the tables as a sequence from minds to the resources they create, to the insights we extract, to the synthesis they produce.
...
Caption: If links to other tables are made from the Synthesis table (as in Example #1), then second-order links must still be created between the other tables.
...
Caption: Visualizing relationships can make abstract relationships more legible
