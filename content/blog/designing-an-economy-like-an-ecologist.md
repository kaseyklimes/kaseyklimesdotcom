...
![](/images/dcf5b527-7128-4195-a9db-e92dbe50c0ef_2000x1252-3.jpg)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_Illustration by [Claire Scully](http://www.clairescully.com/) for Aeon__

_My collaborator Oshan Jarow and I recently made public the_[**_Library of Economic Possibility_**](http://economicpossibility.org/)_, a knowledge tool for economic ideas just outside the Overton window. LEP is motivated by our belief that the economy should be understood as a complex adaptive system and economic policy as a design problem within it. It’s also a reaction to a deep structural problem with mainstream economic thought._
...
![](/images/c540d7c6-efba-4c0a-b132-2f3fd0e2637b_2000x1125-1.jpg)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_A Soviet control room__
...
Physics is rich with elegant mathematical equations, so these economists took them. I mean this quite literally. The neoclassical economic model of general equilibrium, which can be found in nearly every economics textbook of the last century, was lifted from chapter two of French mathematician Louis Poinsot's _Elements of Statics_ (1803) by Léon Walras. Walras made this model the centerpiece of his _Elements of a Pure Economics_ in 1872, and it spread rapidly in the decades that followed.

Our modern economic system relies on a 220-year-old physics model that was [already rendered obsolete among physicists](https://en.wikipedia.org/wiki/Ludwig_Boltzmann) by new understandings of entropy and thermodynamic behavior at the time that Walras was taking it to Kinko's.

However, in order to turn the economy into a simple static model, neoclassical economists had to make a few assumptions (the first of which effectively erases Hayek's [1](https://rhizomerd.substack.com/p/designing-an-economy-like-an-ecologist#footnote-1-106223133) insight):
...
The neoclassical model’s assumptions take it to a radical end: If markets always find balance, then the sole role of policy must be to cease meddling with their course. Simply put, _we must eliminate all forms of intervention._ But in mistaking model for reality and logical extreme for pragmatic mandate, this conclusion casts a spell that has cost us dearly.
...
The previous economic model had its own clear failings, but if economic growth, shared prosperity, and business dynamism were the goal of the new system, then [this project has failed](https://lepossibilities.substack.com/i/104344359/what-comes-after-neoliberalism-should-work-better). [Economic growth has slowed to a crawl](https://rooseveltinstitute.org/wp-content/uploads/2020/07/RI_The-Empirical-Failures-of-Neoliberalism_brief-202001.pdf), [inequality has skyrocketed](https://www.newyorker.com/news/john-cassidy/pikettys-inequality-story-in-six-charts), and we now have [more businesses dying than being born](https://www.washingtonpost.com/news/on-small-business/wp/2015/02/12/the-decline-of-american-entrepreneurship-in-five-charts/). Rather than tending towards equilibrium, a strict adherence to non-interventionism has led to a new form of [consolidated control by rent-seekers](https://jpia.princeton.edu/news/something-nothing-how-growing-rent-seeking-heart-americas-economic-troubles) in the private sector.
![](/images/77e99b47-3f81-4349-8b13-cb6967fdb93a_1220x596-1.jpg)
...
![](/images/9d76b657-b159-4c5b-9bce-8267ca105d06_2048x2048-1.jpg)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_High modernism, by Midjourney__
...
The core problem with both systems is that they aren’t based on reality. They are simplified models derived from [idealized blank-slate visions of what that reality _ought_to look like](https://www.ribbonfarm.com/2010/07/26/a-big-little-idea-called-legibility/), imposed from above on the rich complexity of real economies.

While it makes for an elegant model, [**economic equilibrium doesn’t actually exist in the real world**](https://www.science.org/doi/10.1126/sciadv.aat1328)**.** The map is not the territory and the model is not the economy. While markets have real strengths, real world economies do not follow a simple physics model’s rules.
...
The prescriptions of central control or pure non-intervention are naïve responses to unrealistic economic models. [Even free markets are designed](https://books.google.com/books?hl=en&lr=&id=p-DO1Yfy7gAC&oi=fnd&pg=PA71&dq=institutional+foundations+of+market+economies&ots=bgVHg1EmrA&sig=opa5GAWLuqBmweDQ2z3tCqnny14#v=onepage&q=institutional%20foundations%20of%20market%20economies&f=false) — they require institutions to create, regulate, and police them.
...
Like ecologies, economies are [complex adaptive systems](https://en.wikipedia.org/wiki/Complex_adaptive_system). They exhibit feedback loops, delays, adaptation, path dependence, nonlinearity, emergent phenomena and — importantly — _people_.
...
![](/images/d09c7785-92da-4e51-b4bd-08740566b0d4_2048x2048-1.png)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_Ecology, by Midjourney__

**So how _do_ we achieve a healthy ecology?**
...
![](/images/7055044c-d3c6-4f45-b222-86bbb43c47bd_976x549-1.jpg)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_Mayflies are an indicator species for water quality__
...
For example, a [2019 study](https://www.economicpossibility.org/sources/universal-cash-transfers-reduce-childhood-obesity-rates) by [Reimer](https://www.economicpossibility.org/authors/matthew-reimer), [Guettabi](https://www.economicpossibility.org/authors/mouhcine-guettabi), and [Watson](https://www.economicpossibility.org/authors/brett-watson) found that a universal $1,000 payment from the Alaska Permanent Fund — a natural experiment in [basic income](https://www.economicpossibility.org/reports/basic-income) — [decreases the probability of an Alaskan child being obese by as much as 4.5%](https://www.economicpossibility.org/insights/evidence-from-the-alaska-permanent-fund-suggests-that-an-additional-one-thousand). They estimate that a national expansion may therefore trigger self-reinforcing positive change resulting in medical cost savings of approximately $310 million.

Or consider the [2016 study](https://www.economicpossibility.org/sources/a-land-value-tax-for-london) that studied the effects of a [land value tax](https://www.economicpossibility.org/reports/land-value-tax) in Harrisburg, Pennsylvania. In the period following the intervention, [the number of vacant lots fell by 80%, the tax base rose from $212 million to $1.6 billion, and crime was cut in half.](https://www.economicpossibility.org/insights/in-the-period-following-harrisburg-pa-s-land-value-tax-the-number-of-vacant-lots)
![](/images/7fced91d-9d3d-432f-88f6-8c5b8bdb44b4_3200x1606-1.jpg)
&nbsp;&nbsp;&nbsp;&nbsp;_&nbsp;&nbsp;&nbsp;&nbsp;_Illustration by [Cristiana Couceiro](https://cristianacouceiro.com/) for [LEP](http://www.economicpossibility.org/)__

Our mission at the [Library of Economic Possibility](https://www.economicpossibility.org/) (LEP) is to make the nuanced work of these economists more accessible to the public. By collecting and sharing studies on the real-world effects of new policy approaches — both successes and limits — LEP aims to help ground popular economic thinking in an empirical and pragmatic understanding of what might be possible amid complexity. From land value tax to [worker codetermination](https://www.economicpossibility.org/reports/codetermination), carefully designed economic interventions may trigger virtuous cycles of prosperity and resilience — if we are willing to experiment with a pragmatic eye towards ecological health.
...
[1](https://rhizomerd.substack.com/p/designing-an-economy-like-an-ecologist#footnote-anchor-1-106223133) _Hayek is a complicated figure in economic history. Though he was heavily involved in the turn toward free market fundamentalism and is often associated with neoclassical economics, his ideas about distributed knowledge constitute an early understanding of the economy as a complex system. Accordingly, he believed that the economy was too complex for equilibrium analysis and that people do not necessarily maximize utility._