...
// Generated by scripts/image-dimensions.mjs before dev and build.
import imageDimensions from '../../../config/image-dimensions.json';
...
function Markdown({ children, reportPages = false }: { children: string; reportPages?: boolean }) {
  return (
    <ReactMarkdown
      ...
      rehypePlugins={[rehypeRaw, [rehypeFigures, { reportPages }], [rehypeImageDimensions, { manifest: imageDimensions }]]}
      components={{
        img: MarkdownImage,
        table: ({ children }) => (
